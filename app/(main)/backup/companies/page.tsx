            ...
            <div className={className}>
                <div className="flex align-items-center gap-2">
                    <div className="ellipsis-container font-bold" style={{ marginLeft: 10, maxWidth: '22vw' }}>
                        {action == ACTIONS.ADD ? 'Add company' : selectedCompany?.name}
                    </div>
                </div>
            </div>
        );
                                        ...
                                        <div className="p-fluid">
                                            ...
                                            {details?.altPOCName && (
                                                <div className="field">
                                                    ...
                                                    <p className="font-bold">
                                                        {details?.altPOCName} ({details?.altPOCNumber})
                                                    </p>
                                                </div>
                                            )}
                                            ...
                                            <div className="mt-2">
                                                {selectedPermissions.map((item) => (
                                                    <p key={item.permissionId} className="sub-text pl-3">
                                                        {item.permission}
                                                    </p>
                                                ))}
                                            </div>
                                        ...
                                        <div className="p-fluid">
                                            ...
                                            <div className="field">
                                                ...
                                                <InputText
                                                    ...
                                                    disabled={action == 'edit' && validateEmail(get(details, 'owner.email'))}
                                                />
                                            </div>

                                            <div className="field">
                                                <label htmlFor="permission">
                                                    Subdomain <span className="red">*</span>
                                                </label>
