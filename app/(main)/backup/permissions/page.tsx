                        ...
                        <div className="left-panel pt-5">
                            ...
                            <div className="card reckitt-table-container mt-4">
                                <DataTable
                                    ...
                                    className="reckitt-table headerless"
                                    ...
                                    {action == 'view' && selectedProduct && get(details, 'permissionId') == selectedProduct.permissionId && (
                                        <>
                                            <p className="sub-heading">
                                                <span style={{ fontWeight: 'normal' }}>Module</span>: {selectedProduct.module}
                                            </p>
                                            <p className="sub-heading" style={{ marginTop: 10 }}>
                                                Permissions
                                            </p>
                                            ...
                                            <p className="sub-heading" style={{ marginTop: 15, marginBottom: 10 }}>
                                                Selected Routes:
                                            </p>
                                            {selectedRoutes &&
                                                uniqBy(selectedRoutes, 'routeId').map((item: any) => {
                                                    return (
                                                        <div key={item.routeId} style={{ padding: 10 }}>
                                                            <span>
                                                                <Tag value={item?.method.toUpperCase()} severity={getOrderSeverity(item)}></Tag>
                                                            </span>
                                                            <span className="font-bold" style={{ paddingLeft: 10 }}>
                                                                {item?.path}
                                                            </span>
                                                        </div>
                                                    );
                                        ...
                                        <div className="p-fluid">
                                            <div className="field">
                                                <label htmlFor="module">
                                                    Module name <span className="red">*</span>
                                                </label>
                                            ...
                                            <div className="field">
                                                <label htmlFor="permission">
                                                    Permission name <span className="red">*</span>
                                                </label>
            ...
            >
                <div className="flex flex-column w-full surface-border p-3">
                    <div className="flex align-items-center">
                        ...
                        <span>
                            This will remove <strong>{selectedProduct?.permission}</strong> permission for following routes.
                            <br /> Do you still want to remove it? This action cannot be undone.
                        </span>
                    </div>
                    <p className="sub-heading" style={{ marginTop: 15, marginBottom: 10 }}>
                        Routes:
                    ...
                    <ScrollPanel style={{ height: 150 }}>
                        ...
                        {!isLoading &&
                            !isDetailLoading &&
                            map(map(get(details, 'routes', []), 'route'), (item) => (
                                <div key={'delete-' + item.routeId} style={{ padding: 10 }}>
                                    <span>
                                        <Tag value={item?.method.toUpperCase()} severity={getOrderSeverity(item)} />
                                    </span>
                                    <span className="font-bold" style={{ paddingLeft: 10 }}>
                                        {item?.path}
                                    </span>
                    ...
                    <div style={{ marginTop: 10 }}>
                        <span>
                            Confirm you want to delete this by typing its name: <strong>{selectedProduct?.permission}</strong>
                        </span>
                        <br />
